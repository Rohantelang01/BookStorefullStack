...
function NavBar() {
  ...
  <div className="navbar-start">
    ...
    <a className="font-bold text-3xl">BookStore</a>
  </div>
  ...
  <label className="px-3 py-2 border rounded-lg flex item-center gap-2">
...
<label className="swap swap-rotate">
  ...
  {/* moon icon */}
  <svg
    className="swap-on h-6 w-6fill-current"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  <div >
    ...
    onClick={()=>
      document.getElementById("my_modal_3").showModal()    }>Login</a>
      <Login/>
  </div>
  </div>
</div>
